...
import { Card, FormatBytes, Link, Table } from '@spare/core';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/Spare-Network/spare-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it">Learn more</Link>
        </Trans>
      }
      interactive
    >
