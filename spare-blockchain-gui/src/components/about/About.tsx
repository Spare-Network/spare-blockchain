...
import icon from '../../assets/img/spare_circle.svg';
  ...
  return (
    <html>
      ...
      <body style={{"-webkit-app-region": "drag"}}>
        ...
        <BugReport href="https://github.com/Spare-Network/spare-blockchain/issues" target="_blank">
          Report an issue
        </BugReport>
        {'{{CSS}}'}
      </body>
