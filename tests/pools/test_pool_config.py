...
from spare.pools.pool_config import PoolWalletConfig
from spare.util.config import load_config, save_config, create_default_spare_config
...
def test_pool_config():
    ...
    create_default_spare_config(test_root, ["config.yaml"])
