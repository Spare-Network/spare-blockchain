...
# the output will be printed to your spare root path, e.g. ~/.sparecoin/mainnet/profile/
# to analyze the profile, run:

#   python spare/utils/profiler.py ~/.sparecoin/mainnet/profile | less -r
...
#   python spare/utils/profiler.py ~/.sparecoin/mainnet/profile 10 20
